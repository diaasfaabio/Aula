    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="form-group">
                <br>
                <input type="hidden" maxlength="30" class="form-control" name="tipo" value="administrador" required>
                <input type="hidden" maxlength="30" class="form-control" name="senha"  required>
